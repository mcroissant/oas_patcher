...
class BundleManager:
    ...
    def load_bundle(self, bundle_name: str) -> BundleConfig:
        ...
        if not bundle_path:
            raise FileNotFoundError(f"Bundle '{bundle_name}' not found in {self.config_dir}")
    ...
    def _parse_bundle_config(self, config_data: Dict[str, Any], bundle_name: str) -> BundleConfig:
    ...
    def get_overlays_for_environment(self, bundle_name: str, environment: str) -> List[OverlayConfig]:
